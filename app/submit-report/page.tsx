  ...
  return (
    <div className="flex p-[6px] gap-[10px] rounded-lg bg-[#F3F4F5]">
      <button
        ...
        className={`flex flex-1 items-center gap-[6px] px-4 py-[13px] rounded-lg cursor-pointer transition-all ${
          value === "yes" ? "bg-white shadow-[0_1px_4px_0_rgba(0,0,0,0.08)]" : "bg-transparent"
        }`}
      >
      ...
      <button
        ...
        onClick={() => onChange("no")}
        className={`flex flex-1 items-center gap-[6px] px-4 py-[13px] rounded-lg cursor-pointer transition-all ${
          value === "no" ? "bg-white shadow-[0_1px_4px_0_rgba(0,0,0,0.08)]" : "bg-transparent"
        }`}
      >
      ...
      <button
        ...
        className={`flex flex-1 items-center gap-[6px] px-4 py-[13px] rounded-lg cursor-pointer transition-all ${
          value === "maybe" ? "bg-white shadow-[0_1px_4px_0_rgba(0,0,0,0.08)]" : "bg-transparent"
        }`}
      >
            ...
            <section className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className={`${inputBase}  py-[14px]`}>
                  <SearchIcon />
                  <span className={placeholderText}>Search for institution...</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="flex flex-col gap-2">
                  ...
                  <div className={`${inputBase}  py-[14px]`}>
                    <SearchIcon />
                    <span className={placeholderText}>Search for Teacher...</span>
                  </div>
                </div>
                <div className="flex flex-col gap-2">
                  <label className={fieldLabel}>Date of Assignment</label>
                  <div className={`${inputBase} justify-between py-[14px]`}>
                    <span className={placeholderText}>MM/DD/YY</span>
                    <CalendarIcon />
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-wrap justify-between">
                  {GRADE_LEVELS.map((level) => (
                    <button
                      ...
                      className={`flex items-center justify-center px-5 py-[10px] rounded-lg font-inter text-sm cursor-pointer transition-all ${
                        gradeLevel === level
                  ...
                  {ALL_TAGS.map((tag) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex items-center justify-center px-[19px] py-[9px] rounded-xl font-inter text-sm cursor-pointer transition-all ${
                          isSelected && !isNeg
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex p-[6px] gap-[10px] rounded-lg bg-[#F3F4F5] w-fit">
                  <button
                    ...
                    className={`flex items-center gap-[6px] px-4 py-[13px] rounded-lg cursor-pointer transition-all ${
                      postAs === "anonymous" ? "bg-white shadow-[0_1px_4px_0_rgba(0,0,0,0.08)]" : "bg-transparent"
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex items-center gap-[6px] px-4 py-[13px] rounded-lg cursor-pointer transition-all ${
                      postAs === "show" ? "bg-white shadow-[0_1px_4px_0_rgba(0,0,0,0.08)]" : "bg-transparent"
                    }`}
                  >
