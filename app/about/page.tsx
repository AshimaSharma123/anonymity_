...
function StatCard({ number, label }: { number: string; label: string }) {
  return (
    <div className="flex gap-2 justify-center flex-col px-10 py-8 rounded-2xl border border-[rgba(1,113,249,0.10)] bg-white shadow-[0_2px_9.9px_0_rgba(0,0,0,0.06)]">
      <span className="text-center  font-[Outfit] text-[40px] font-semibold leading-[normal] bg-gradient-to-r from-[#29ABE2] to-[#0171F9] bg-clip-text text-transparent">
        {number}
      </span>
      <span className="font-inter text-base text-[#212121] leading-[26px] opacity-[0.96] text-center">{label}</span>
    </div>
  );
}
  ...
  return (
    <>
      ...
      <main className="bg-white">
        ...
        {/* ── HERO ─────────────────────────────────────────────────────── */}
        <section className="bg-[#F8F9FD] px-6 py-20 md:py-28 text-center">
          <SectionBadge label="About Us" />
          <div className="flex flex-col items-center gap-8">
            <h1 className="font-inter text-[clamp(36px,5vw,64px)] font-bold leading-[normal] text-[#121212]">
            ...
            <p className="mb-2 max-w-[615px] font-inter text-base text-[#212121] leading-[26px] opacity-[0.96]">
            ...
            <div className="flex items-center gap-4 flex-wrap justify-center">
              <Link
                href="/browse-school"
                className="flex items-center justify-center px-8 py-4 rounded-xl bg-[#0171F9] text-white font-inter text-base font-bold leading-6 hover:bg-blue-700 transition-colors shadow-[0_10px_15px_-3px_rgba(1,113,249,0.06),0_4px_6px_-4px_rgba(1,113,249,0.12)]"
              >
                Browse Schools
              </Link>
              <Link
                href="/submit-report"
                className="flex items-center justify-center px-8 py-4 rounded-xl border border-black/20 bg-white text-[#2C3031] font-inter text-base font-bold leading-6 hover:border-black/40 transition-colors"
              >
                Submit a Report
              </Link>
            </div>
        ...
        {/* ── HOW IT WORKS ─────────────────────────────────────────────── */}
        <section className="pt-[112px] bg-white px-6 pb-[112px] text-center">
          <SectionBadge label="How its Work" />
          <div className="flex flex-col items-center gap-10">
            <div className="flex flex-col items-center gap-3 text-center">
              <h2 className="font-[Outfit] text-[clamp(28px,4vw,44px)] font-semibold text-[#121212] leading-[1.32]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-[1100px]">
              {/* Card 1 */}
              <div className="relative text-left flex flex-col gap-5 p-7 rounded-[26px] bg-[#F8F9FD] overflow-hidden">
                ...
                <h3 className="font-[Outfit] text-2xl font-semibold text-[#2C3031] leading-8">Submit a Report</h3>
              ...
              <div className="relative text-left flex flex-col gap-5 p-7 rounded-[26px] bg-[#F8F9FD] overflow-hidden">
                ...
                <h3 className="mt-[10px] font-[Outfit] text-2xl font-semibold text-[#2C3031] leading-8">Data Gets Analyzed</h3>
                <p className="font-inter text-base text-[#212121] leading-[26px] opacity-[0.96]">
              ...
              <div className="relative text-left flex flex-col gap-5 p-7 rounded-[26px] bg-[#F8F9FD] overflow-hidden">
                ...
                <h3 className="mt-[10px] font-[Outfit] text-2xl font-semibold text-[#2C3031] leading-8">Community Benefits</h3>
                <p className="font-inter text-base text-[#212121] leading-[26px] opacity-[0.96]">
          ...
          <div className="rounded-[28px] bg-[#F8F9FD] px-10 md:px-30 py-[112px]">
            ...
            <div className=" flex flex-col lg:flex-row gap-12">
              <div className="flex flex-col gap-6 flex-1">
                <h2 className="font-[Outfit] text-[clamp(28px,3.8vw,50px)] font-semibold text-[#121212] leading-[1.32]">
                  The Hesitant Substitute
                </h2>
                <div className="flex flex-col gap-5 font-inter text-base text-[#212121] leading-[26px] opacity-[0.96] w-[70%]">
                  <p>
              ...
              <div className="grid grid-cols-2 gap-5 lg:flex-shrink-0">
        ...
        <section className="bg-white px-6 py-[112px] text-center">
          ...
          <div className="flex flex-col items-center gap-14">
            <div className="flex flex-col items-center gap-3 text-center">
              ...
              <p className="font-inter text-base text-[#212121] leading-[26px] opacity-[0.96] max-w-[650px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full max-w-[1100px]">
              {/* Anonymous & Safe */}
              <div className="flex items-start gap-0 rounded-2xl border border-[rgba(1,113,249,0.10)] bg-[#F8F9FD] shadow-[0_4px_4px_0_rgba(0,0,0,0.08)] overflow-hidden p-9">
                <div className="mt-[10px] flex-shrink-0 w-11 h-11 rounded-[9px] bg-[rgba(1,113,249,0.10)] flex items-center justify-center mr-6">
                ...
                <div>
                  <h3 className="text-left font-[Outfit] text-2xl font-semibold text-[#2C3031] leading-8 mb-3">Anonymous &amp; Safe</h3>
                  <p className="text-left font-inter text-base text-[#212121] leading-[26px] opacity-[0.96]">
              ...
              <div className="flex items-start gap-0 rounded-2xl border border-[rgba(1,113,249,0.10)] bg-[#F8F9FD] shadow-[0_4px_4px_0_rgba(0,0,0,0.08)] overflow-hidden p-9">
                ...
                <div>
                  <h3 className="text-left font-[Outfit] text-2xl font-semibold text-[#2C3031] leading-8 mb-3">Peer-Sourced Truth</h3>
                  <p className="text-left font-inter text-base text-[#212121] leading-[26px] opacity-[0.96]">
              ...
              <div className="flex items-start gap-0 rounded-2xl border border-[rgba(1,113,249,0.10)] bg-[#F8F9FD] shadow-[0_4px_4px_0_rgba(0,0,0,0.08)] overflow-hidden p-9">
                ...
                <div>
                  <h3 className="text-left font-[Outfit] text-2xl font-semibold text-[#2C3031] leading-8 mb-3">Community Power</h3>
                  <p className="text-left font-inter text-base text-[#212121] leading-[26px] opacity-[0.96]">
              ...
              <div className="flex items-start gap-0 rounded-2xl border border-[rgba(1,113,249,0.10)] bg-[#F8F9FD] shadow-[0_4px_4px_0_rgba(0,0,0,0.08)] overflow-hidden p-9">
                ...
                <div>
                  <h3 className="text-left font-[Outfit] text-2xl font-semibold text-[#2C3031] leading-8 mb-3">Actionable Insights</h3>
                  <p className="text-left font-inter text-base text-[#212121] leading-[26px] opacity-[0.96]">
        ...
        <section className="">
          <div className="rounded-[28px] bg-[#F8F9FD] px-10 md:px-16 py-[112px] text-center">
            ...
            <div className="flex flex-col items-center gap-14">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full max-w-[1100px]">
                {[
                  ...
                  <div key={g.id} className="flex items-start gap-5 p-7 rounded-2xl border border-[rgba(1,113,249,0.10)] bg-white shadow-[0_2px_9.9px_0_rgba(0,0,0,0.06)]">
                    <CheckCircleIcon id={g.id} />
                    <div>
                      <h3 className="text-left font-[Outfit] text-2xl font-semibold text-[#2C3031] leading-8 mb-2">{g.title}</h3>
                      <p className="font-inter text-left text-base text-[#212121] leading-[26px] opacity-[0.96]">{g.desc}</p>
                    </div>
                  </div>
                ))}
              </div></div>
        ...
        <section className="bg-white px-6 py-[112px] flex flex-col items-center gap-10">
          <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16 w-full max-w-[1100px]">
            {/* Left: quote card */}
            <div
              className="relative flex-shrink-0 w-full max-w-[471px] rounded-[26px] overflow-hidden p-9 flex flex-col gap-8"
              style={{ background: "linear-gradient(117deg, #0171F9 7.46%, #29ABE2 89.56%)", minHeight: "306px" }}
            >
              {/* Decorative circles */}
              ...
              {/* Quote */}
              <p className="font-inter text-xl font-normal text-white leading-[34px] opacity-[0.96] relative z-10">
            ...
            <div className="">
              ...
              <div className="flex flex-col gap-6 flex-1">
                ...
                <div className="flex flex-col gap-5 font-inter text-base text-[#212121] leading-[26px] opacity-[0.96]">
                  <p>
          ...
          <div className="rounded-[28px] bg-[#F8F9FD] px-10 md:px-16 py-[112px] text-center">
            ...
            <div className="flex flex-col items-center gap-14">
              <div className="flex flex-col items-center gap-3 text-center">
                ...
                <p className="font-inter text-base text-[#212121] leading-[26px] opacity-[0.96] max-w-[645px]">
              ...
              <div className="flex flex-col md:flex-row items-start justify-center gap-0 w-full max-w-[1100px]">
                {[
                  {
                    img: "/one.svg",
                  ...
                  <div key={i} className="flex flex-col md:flex-row items-stretch flex-1 min-w-0">
                    <div className="flex flex-col items-center gap-5 flex-1 px-6 py-6 md:py-0">
                      {step.img ? (
                      ...
                      <div className="flex flex-col items-center gap-5">
                        <h3 className="font-[Outfit] text-[22px] font-semibold text-[#121212] text-center leading-[normal]">{step.title}</h3>
                        <p className="font-inter text-base font-normal text-center text-gray-700 leading-[26px] text-center">{step.desc}</p>
                      </div>
                    </div>
                    {i < 2 && (
        ...
        <section className="bg-white px-6 py-[112px] text-center">
          ...
          <div className="flex flex-col items-center gap-10">
            <h2 className="font-[Outfit] text-[clamp(28px,4vw,44px)] font-semibold text-[#121212] text-center leading-[1.32]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-[1100px]">
              ...
              <div className="rounded-[26px] bg-[#F8F9FD] overflow-hidden flex flex-col">
                <div className="flex items-center justify-center gap-3 px-7 py-5 bg-[rgba(1,113,249,0.06)]">
                  ...
                  <span className="font-[Outfit] text-2xl font-medium text-[#121212] leading-8">Mission</span>
                </div>
                <div className="px-7 py-8">
                  <p className="font-inter text-base text-[#212121] text-center leading-[26px] opacity-[0.96]">
              ...
              <div className="rounded-[26px] bg-[#F8F9FD] overflow-hidden flex flex-col">
                <div className="flex items-center justify-center gap-3 px-7 py-5 bg-[rgba(1,113,249,0.06)]">
                  ...
                  <span className="font-[Outfit] text-2xl font-medium text-[#121212] leading-8">Vision</span>
                </div>
                <div className="px-7 py-8">
                  <p className="font-inter text-base text-[#212121] text-center leading-[26px] opacity-[0.96]">
              ...
              <div className="rounded-[26px] bg-[#F8F9FD] overflow-hidden flex flex-col">
                <div className="flex items-center justify-center gap-3 px-7 py-5 bg-[rgba(1,113,249,0.06)]">
                  ...
                  <span className="font-[Outfit] text-2xl font-medium text-[#121212] leading-8">Goal</span>
                </div>
                <div className="px-7 py-8">
                  <p className="font-inter text-base text-[#212121] text-center leading-[26px] opacity-[0.96]">
