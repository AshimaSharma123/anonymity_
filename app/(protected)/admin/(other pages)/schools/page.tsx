    ...
    <div className="flex-1 overflow-y-auto">
      ...
      <div className="flex items-center justify-between px-4 sm:px-6 lg:px-8 py-4 sm:py-[26px]">
        ...
        <div className="flex items-center gap-2 sm:gap-4 flex-shrink-0">
          ...
          <button
            onClick={onCancel}
            className="flex items-center gap-1 sm:gap-1.5 px-2.5 sm:px-4 py-2 sm:py-3 rounded-lg bg-[#0171F9] cursor-pointer hover:bg-[#0161d9] transition-colors"
          >
            <svg width="16" height="16" viewBox="0 0 20 20" fill="none" className="sm:w-5 sm:h-5 flex-shrink-0">
            ...
            <span className="hidden sm:inline font-inter font-semibold text-sm sm:text-base text-white">Save</span>
          </button>
        </div>
      </div>
      ...
      <div className="px-4 sm:px-6 lg:px-8 pb-6 sm:pb-10">
        <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 max-w-[720px] mx-auto flex flex-col gap-6 sm:gap-8 lg:gap-10">
                ...
                <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                  {ASSOCIATIONS.map((assoc) => (
                    <button
                      ...
                      className={`px-3 sm:px-6 py-1.5 sm:py-2 rounded-lg border font-inter text-xs sm:text-sm font-medium transition-all cursor-pointer ${
                  ...
                  {GRADE_LEVELS.map((grade) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg font-inter text-xs sm:text-sm font-medium transition-all cursor-pointer ${
                          selected
          ...
          <div className="flex flex-row items-center justify-end gap-2 sm:gap-3">
            ...
            <button
              onClick={onCancel}
              className="w-full sm:w-auto flex items-center justify-center gap-1 sm:gap-1.5 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg bg-[#0171F9] cursor-pointer hover:bg-[#0161d9] transition-colors"
            >
              <svg width="16" height="16" viewBox="0 0 18 18" fill="none" className="sm:w-[18px] sm:h-[18px]">
    ...
    <main className="flex-1 overflow-y-auto p-6 lg:p-8">
      ...
      <div className="flex flex-row items-center justify-between gap-4 sm:gap-6 mb-4 sm:mb-6 lg:mb-8">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 sm:px-[17px] py-2 sm:py-3 rounded-lg bg-[#0171F9] shadow-sm hover:bg-[#0161d9] transition-colors cursor-pointer flex-shrink-0 w-auto justify-start"
        >
          <PlusIcon />
                ...
                paginated.map((school) => {
                  ...
                  return (
                    <tr key={school.id} className="border-b border-[#F2F4F7] hover:bg-[#F8FAFF] transition-colors">
                      ...
                      <td className="px-2 sm:px-4 lg:px-5 py-2.5 sm:py-[17.5px] whitespace-nowrap">
                        <Link href={`/schools/${school.id}`} className="flex items-center justify-center h-8 sm:h-9 px-2 sm:px-3.5 rounded-md border border-[#EFF0F2] bg-white font-inter font-normal text-[12px] sm:text-[14px] text-black opacity-80 tracking-[-0.2px] hover:opacity-100 transition-opacity">
                          View Detail
                        </Link>
                      </td>
                    </tr>
